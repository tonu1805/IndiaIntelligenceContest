<html>
	...
	<body>
		<div class = "container">
			...
			<form class = "form-horizontal" role = "form" action = "form_process_sch.php" method = "post">
				...
				<div class = "form-group">
					...
					<div class = "col-sm-5">
						<input type="text" value = "" id="number" class = "form-control" name = "mob" placeholder = "Mobile Number of the First Student" required>
					</div>		
				</div>
				<div class = "form-group">
					<label for = "email" class = "control-label col-sm-3">E-mail Address *</label>
					<div class = "col-sm-5">
						<input type="email" value = "" id="email" class = "form-control" name = "email" placeholder = "Email Address of the First Student" required>
					</div>		
				</div>
				<div class = "form-group">
					<label for = "email" class = "control-label col-sm-3">Whether transportation required *</label>
					<div class = "col-sm-2">
